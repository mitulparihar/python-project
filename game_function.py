...
def update_bullets(ai_settings , screen , ship ,aliens ,bullets,sb,stats):
	'''Update position and get ride of old bullets'''
	bullets.update()
	for bullet in bullets.copy():
		if bullet.rect.bottom <= 0:
			bullets.remove(bullet)
		#get rid of bullet if they hit aliens . 
	check_bullet_ship_collision(ai_settings , screen , ship , aliens , bullets,sb,stats)		
def check_bullet_ship_collision(ai_settings , screen , ship , aliens , bullets,sb,stats):
	collisions = pygame.sprite.groupcollide(bullets , aliens ,True , True)
	if collisions:
		ai_settings.alien_hit_sound.play()
...
def update_aliens(ai_settings,screen ,ship,aliens,bullets,stats,sb):
	...
	aliens.update()
	#Look for ship and alien collison
